        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          ...
          <div className="w-full lg:w-5/12 space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed tracking-wide text-base md:text-lg text-justify font-light">
              G Music is managed by a dynamic team of industry veterans, blending over 20 years of solid groundwork with a fresh, forward-looking perspective. Our top management excels in planning, organizing, and delivering high-level entertainment functions, supported by a staff capable of expert logistics, innovative marketing, and strategic promotion. This depth of experience allows us to ensure the seamless delivery of every event, regardless of scale.
            </p>
            <p className="text-gray-400 leading-relaxed tracking-wide text-base md:text-lg text-justify font-light">
              Driven by a bold ambition, we aim to establish G Music as a leading force in the Asia Pacific entertainment landscape. By capturing the hottest trends and anticipating future iconic developments, we are positioning ourselves at the forefront of pop culture, ready to define the next generation of entertainment.
            </p>
          </div>
