  ...
  return (
    <div className="min-h-screen pt-32 pb-32 bg-black selection:bg-[#D4AF37] selection:text-black">
      ...
      <div className="max-w-[1400px] mx-auto px-6 mb-16">
        <h1 className="text-5xl font-serif gold-text tracking-[0.2em] mb-16 text-center uppercase animate-on-scroll opacity-0 translate-y-8 transition-all duration-1000">
          CONTACT US
        </h1>
      </div>
            ...
            <div className="space-y-12">
              <div className="group">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-xl font-serif gold-text tracking-widest uppercase">ADDRESS</h2>
                </div>
                <p className="text-gray-400 leading-relaxed tracking-wide text-base md:text-lg font-light pl-2">
                  Room 1808, Midas Plaza,<br />
                  1 Tai Yau Street,<br />
            ...
            <div className="space-y-12">
              ...
              <div className="group">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-xl font-serif gold-text tracking-widest uppercase">TEL</h2>
                </div>
              ...
              <div className="group">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-xl font-serif gold-text tracking-widest uppercase">FAX</h2>
                </div>
              ...
              <div className="group">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-xl font-serif gold-text tracking-widest uppercase">E-MAIL</h2>
                </div>
