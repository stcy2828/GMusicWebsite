...
import { getInfoItems } from '../constants';
...
const InfoSection: React.FC = () => {
  ...
  useEffect(() => {
    // Fetch information from static data and limit to the most recent 5 items
    const allItems = getInfoItems();
  ...
  return (
    <section ref={sectionRef} className="py-24 px-4 bg-black min-h-[400px]">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-serif gold-text tracking-[0.3em] mb-20 text-center">{t.info.title}</h2>
